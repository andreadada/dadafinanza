          ...
          if (state.archivedAccounts.isNotEmpty) ...[
            ...
            ...state.archivedAccounts.map(
              (account) => ListTile(
                ...
                subtitle: const Text('Conto archiviato · storico conservato'),
              ...
              PopupMenuItem(
                ...
                child: Text(
                  account.includeInTotal
                      ? 'Escludi dal patrimonio'
                      : 'Includi nel patrimonio',
                ),
              ),
              PopupMenuItem(
                value: 'analytics',
                child: Text(
                  account.includeInAnalytics
      ...
      body: ListView(
        ...
        children: [
          ...
          FlatMetric(
            ...
            icon: Icons.arrow_downward_rounded,
            color: transactionColor(context, TransactionType.income),
          ),
          const Divider(height: 1),
          FlatMetric(
            label: 'Spese',
            ...
            icon: Icons.arrow_upward_rounded,
            color: transactionColor(context, TransactionType.expense),
          ),
          const Divider(height: 1),
          FlatMetric(
            label: 'Cash flow',
          ...
          SectionTitle(
            'Movimenti recenti',
            trailing: Text('${state.transactionCountForAccount(account.id)}'),
          ),
          if (movement.isEmpty)
            const EmptyState(
              icon: Icons.receipt_long_outlined,
              title: 'Nessun movimento',
              subtitle: 'I movimenti di questo conto compariranno qui.',
            )
          else
      ...
      builder: (context, setSheetState) => Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                existing == null ? 'Nuovo conto' : 'Modifica conto',
              ...
              ListTile(
                ...
                subtitle: const Text('Scegli per categoria'),
                trailing: const Icon(Icons.chevron_right_rounded),
                onTap: () async {
                ...
                child: advanced
                    ? Column(
                        children: [
                          ...
                          SwitchListTile(
                            contentPadding: EdgeInsets.zero,
                            title: const Text('Nascondi saldo del conto'),
                            value: hideBalance,
                            onChanged: (value) =>
